...
class Game:
    ...
    def set_game(self):
        ...
        for key, value in self.car_config.items():
            car = Car(name=key, length=value[0], location=value[1], orientation=value[2])
    ...
    def play(self, car, direction):
        ...
        :return: None
        """
        self.car[car].update_location(direction)
        self.board_game.update_board(car_location=self.cars.__CarLocation)
